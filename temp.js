	...
	// 		await this.onClickUpdateTrafficFunctions(event)
	// 	} catch(error) {
...
export default class DBeditUsersContainer extends React.Component{
	...
	displaySwitchToIndex = async (user) => {
		this.setState({
			display: 'index',
			user: user
		})
	...
	render(){
		...
		// console.log("4", this.state.users)
